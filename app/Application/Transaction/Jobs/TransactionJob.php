...
use App\Domain\PaymentInstruction\Services\PaymentInstruction\PaymentInstructionByResourceIdService;
...
final class TransactionJob implements ShouldQueue
{
    ...
    public function __construct(
        private readonly string $paymentInstructionResourceId,
        private readonly TransactionCreateRequestDTO $requestDTO,
    ) {
        // ...
    }
