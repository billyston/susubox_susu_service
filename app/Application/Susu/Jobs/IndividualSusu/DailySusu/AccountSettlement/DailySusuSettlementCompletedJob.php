...
use App\Domain\Susu\Services\IndividualSusu\DailySusu\AccountSettlement\DailySusuSettlementCompletedService;
...
final class DailySusuSettlementCompletedJob implements ShouldQueue
{
    ...
    public function handle(
        ...
        // Resolve and execute the DailySusuAccountCycleCreateService
        match (true) {
            // Handle the guards
