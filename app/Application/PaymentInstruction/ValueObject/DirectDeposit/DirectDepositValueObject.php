...
namespace App\Application\PaymentInstruction\ValueObject\DirectDeposit;
...
final readonly class DirectDepositValueObject
{
    ...
    /**
     * @param array $payload
     * @param Money|null $recurringAmount
     * @param Money|null $charge
     * @return self
    ...
    public static function create(
        ...
        if ($depositType === DepositType::FREQUENCY->value) {
            $amount = $recurringAmount->multipliedBy($frequencies);
        } else {
