...
use App\Application\PaymentInstruction\Jobs\RecurringDeposit\RecurringDepositPausedJob;
...
final class RecurringDepositPauseAction
{
    /**
    ...
    public function execute(
        ...
        RecurringDepositPausedJob::dispatch(
