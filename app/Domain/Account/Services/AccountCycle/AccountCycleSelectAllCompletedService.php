...
final class AccountCycleSelectAllCompletedService
{
    /**
    ...
    public function execute(
        ...
        try {
            // Run the query to fetch all completed cycles
            ...
            Log::error('Exception in AccountCycleSelectAllCompletedService', [
                'account' => $account,
                'exception' => [
