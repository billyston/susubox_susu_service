 ...
 *
 * @method static Builder|BizSusu whereResourceId($value)
 * @method static Builder|BizSusu whereIndividualAccountId($value)
 * @method static Builder|BizSusu whereWalletId($value)
 * @method static Builder|BizSusu whereFrequencyId($value)
 *
 * @mixin Eloquent
 */
final class BizSusu extends Model
{
    ...
    protected static function booted(
        ...
        BizSusu::deleting(function (BizSusu $bizSusu) {
