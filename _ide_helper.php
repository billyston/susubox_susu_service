...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \App\Domain\Shared\Models\User|null
         * @static
         */
         ...
         *
         * @return \App\Domain\Shared\Models\User
    ...
    class Queue {
        ...
        /**
         * RecurringDeposit a queue by its connection and name.
         *
        ...
        /**
         * RecurringDeposit a queue by its connection and name for a given amount of time.
         *
         * @param string $connection
         * @param string $queue
